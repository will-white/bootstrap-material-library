...
const suites = [['contrast', require('./contrast')], ['namespace', require('./namespace')], ['audit', require('./audit')], ['hit-areas', require('./hit-areas')], ['icon', require('./icon')], ['morph', require('./morph')], ['spec', require('./spec')]];
(async () => {
  const failures = [];
